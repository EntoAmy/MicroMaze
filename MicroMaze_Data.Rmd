...
ggplot(sankey_data,
       aes(axis1 = S, axis2 = M.N.E.D, y = Frequency)) +
  geom_alluvium(aes(fill = S), width = 1/12) +
  geom_stratum(width = 1/12, fill = "grey90", color = "black") +
  geom_text(stat = "stratum", aes(label = after_stat(stratum)),
            size = 3, hjust = -0.1) +
  scale_x_discrete(limits = c("Species","M.N.E.D"), expand = c(.1, .1)) +
...
ggplot(sankey_data_top,
  ...
  geom_text(stat = "stratum", aes(label = after_stat(stratum)),
            size = 3, hjust = -0.1) +
  scale_x_discrete(limits = c("M.N.E.D", "Species"), expand = c(.1, .1)) +
  paletteer::scale_fill_paletteer_d("dichromat::BluetoOrange_10") +
  labs(title = "Sankey Diagram: Species Occurrence by Time of Day",
       x = NULL, y = "Number of Observations") +
